...
#            "E_Wet", "images/EmmaSprite/EmmaSprite_Panties_Wet.png", #readd when sprite works 
        ...
        (0,0), ConditionSwitch(
            ...
            "True", ConditionSwitch(                
                    ...
                    "E_Wet", ConditionSwitch(   
                        ...
                        "E_Legs == 'red sports shorts' ", "images/EmmaSprite/Emma_Sprite_ShortsRed.png",
                        "E_Legs == 'white sports shorts' ", "images/EmmaSprite/Emma_Sprite_ShortsWhite.png",
                        "E_Legs == 'NewX' ", "images/EmmaSprite/EmmaSprite_Pants_NewX.png",
                        "E_Legs == 'NewX black' ", "images/EmmaSprite/EmmaSprite_Pants_NewXBlack.png",
                        "E_Legs == 'skirt' ", "images/EmmaSprite/EmmaSprite_Skirt.png",
                        "True", Null(),
                        ),
                    "True", ConditionSwitch(   
                        #if she's wet
                        "E_Legs == 'pants' ", "images/EmmaSprite/EmmaSprite_PantsWet.png",
                        "E_Legs == 'black pants' ", "images/EmmaSprite/EmmaSprite_Pants_BlackWet.png",
                        "E_Legs == 'yoga pants' ", "images/EmmaSprite/EmmaSprite_Pants_YogaWet.png",
                        "E_Legs == 'red sports shorts' ", "images/EmmaSprite/Emma_Sprite_ShortsRedWet.png",
                        "E_Legs == 'white sports shorts' ", "images/EmmaSprite/Emma_Sprite_ShortsWhiteWet.png",
                        "E_Legs == 'NewX' ", "images/EmmaSprite/EmmaSprite_Pants_NewXWet.png",
                        "E_Legs == 'NewX black' ", "images/EmmaSprite/EmmaSprite_Pants_NewXBlackWet.png",
                        "E_Legs == 'skirt' ", "images/EmmaSprite/EmmaSprite_Skirt.png",
                        "True", Null(),
                        ),                    
                    ),    
        ...
        (0,0), ConditionSwitch(
            ...
            "E_Chest in ('corset','lace bra','sports bra','bikini top','black corset','NewX','NewX black')", "images/EmmaSprite/EmmaSprite_TitsUp.png",   # E_TitsUp = 1
