                    ...
                    "On second thought, forget about that one outfit. . .":
                        menu:
                            ...
                            "Custom 3 [[clear custom 3] (locked)" if not E_Custom3[0]:
                                pass
                            "Custom 4 [[clear custom 4]" if E_Custom3[0]:
                                ch_e "Very well."
                                $ E_Custom3[0] = 0
                            "Custom 4 [[clear custom 4] (locked)" if not E_Custom4[0]:
                                pass
                            "Custom 5 [[clear custom 5]" if E_Custom3[0]:
                                ch_e "Very well."
                                $ E_Custom3[0] = 0
                            "Custom 5 [[clear custom 5] (locked)" if not E_Custom5[0]:
                                pass
                            "Custom 6 [[clear custom 6]" if E_Custom3[0]:
                                ch_e "Very well."
                                $ E_Custom3[0] = 0
                            "Custom 6 [[clear custom 6] (locked)" if not E_Custom6[0]:
                                pass
                            "Custom 7 [[clear custom 7]" if E_Custom3[0]:
                                ch_e "Very well."
                                $ E_Custom3[0] = 0
...
#                                "She pulls out her bra and slips it on under her [E_Over]."
                        elif ApprovalCheck("Emma", 700, TabM=2):
                                ch_e "I suppose I could."
                                $ E_Chest = "NewX"
                                ...
                                ch_e "I suppose I could."
                                $ E_Chest = "NewX black"
                                "She pulls out her black X-men bra and slips it on under her [E_Over]."
                                ...
                                $ E_Chest = "bikini top"
                                call Emma_Tits_Up
                                "She pulls out her bikini top and slips it on under her [E_Over]."
            ...
            menu:
                ...
                "That outfit we put together [[custom]" if E_Custom[0] or E_Custom2[0] or E_Custom3[0]:
                            menu:
                                ...
                                "The fourth one. (locked)" if not E_Custom3[0]:
                                    pass
                                "The fourth one." if E_Custom3[0]:
                                    if E_Custom4[0] == 2 or Count == 99:
                                        $ Count = 10
                                    else:
                                        ch_e "I said I'm not wearing that one in public."

                                "The fifth one. (locked)" if not E_Custom3[0]:
                                    pass
                                "The fifth one." if E_Custom3[0]:
                                    if E_Custom5[0] == 2 or Count == 99:
                                        $ Count = 11
                                    else:
                                        ch_e "I said I'm not wearing that one in public."

                                "The sixth one. (locked)" if not E_Custom3[0]:
                                    pass
                                "The sixth one." if E_Custom3[0]:
                                    if E_Custom6[0] == 2 or Count == 99:
                                        $ Count = 12
                                    else:
                                        ch_e "I said I'm not wearing that one in public."

                                "The seventh one. (locked)" if not E_Custom3[0]:
                                    pass
                                "The seventh one." if E_Custom3[0]:
...
label E_AltClothes(Outfit=8):
        ...
        if E_Schedule[Outfit] == 1 or not E_Schedule[Outfit]:
                    ...
                    $ E_Outfit = "custom4"
        elif E_Schedule[Outfit] == 11:
                    $ E_Outfit = "custom5"
        elif E_Schedule[Outfit] == 12:
                    $ E_Outfit = "custom6"
        elif E_Schedule[Outfit] == 13:
                    $ E_Outfit = "custom7"
...
label Emma_Custom_Out(Custom = 3, Shame = 0, Agree = 1):
            ...
            if "exhibitionist" in E_Traits:
                        ...
                        elif Custom == 10 and E_Custom4[0] == 2:
                            $ E_Outfit = "custom4"
                            $ E_Shame = E_OutfitShame[6]
                        elif Custom == 11 and E_Custom5[0] == 2:
                            $ E_Outfit = "custom5"
                            $ E_Shame = E_OutfitShame[6]
                        elif Custom == 12 and E_Custom6[0] == 2:
                            $ E_Outfit = "custom6"
                            $ E_Shame = E_OutfitShame[6]
                        elif Custom == 13 and E_Custom7[0] == 2:
                            $ E_Outfit = "custom7"
                            $ E_Shame = E_OutfitShame[6]
                        else: #if custom 1:
                            $ E_Outfit = "custom1"
