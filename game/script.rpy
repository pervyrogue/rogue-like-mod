...
label Rogue_Schedule(Clothes = 1, Location = 1, LocTemp = R_Loc):
        ...
        if (Current_Time == "Morning" and Clothes and Round >= 90) or Clothes == 2:
                ...
                if R_Schedule[Weekday] == 1:
                        ...
                        $ R_OutfitDay = "custom3"
                elif R_Schedule[Weekday] == 10 and R_Custom4[0]:
                        $ R_OutfitDay = "custom4"
                elif R_Schedule[Weekday] == 11 and R_Custom5[0]:
                        $ R_OutfitDay = "custom5"
                elif R_Schedule[Weekday] == 12 and R_Custom6[0]:
                        $ R_OutfitDay = "custom6"
                elif R_Schedule[Weekday] == 13 and R_Custom7[0]:
                        $ R_OutfitDay = "custom7"
                else:
...
label Kitty_Schedule(Clothes = 1, Location = 1, LocTemp = K_Loc):
        ...
        if (Current_Time == "Morning" and Clothes and Round >= 90) or Clothes == 2:
                ...
                if K_Schedule[Weekday] == 1: #Tue
                        ...
                        $ K_OutfitDay = "custom3"
                elif K_Schedule[Weekday] == 10 and K_Custom4[0]: #Sun
                        $ K_OutfitDay = "custom4"
                elif K_Schedule[Weekday] == 11 and K_Custom5[0]: #Sun
                        $ K_OutfitDay = "custom5"
                elif K_Schedule[Weekday] == 12 and K_Custom6[0]: #Sun
                        $ K_OutfitDay = "custom6"
                elif K_Schedule[Weekday] == 13 and K_Custom7[0]: #Sun
                        $ K_OutfitDay = "custom7"
                else: #Mon
...
label Emma_Schedule(Clothes = 1, Location = 1, LocTemp = E_Loc):
        ...
        if (Current_Time == "Morning" and Clothes and Round >= 90) or Clothes == 2:
                ...
                if E_Schedule[Weekday] == 1:
                        ...
                        $ E_OutfitDay = "custom3"
                elif E_Schedule[Weekday] == 10 and E_Custom4[0]:
                        $ E_OutfitDay = "custom4"
                elif E_Schedule[Weekday] == 11 and E_Custom5[0]:
                        $ E_OutfitDay = "custom5"
                elif E_Schedule[Weekday] == 12 and E_Custom6[0]:
                        $ E_OutfitDay = "custom6"
                elif E_Schedule[Weekday] == 13 and E_Custom7[0]:
                        $ E_OutfitDay = "custom7"
                else: # random
                        $ Options = ["teacher"]
...
label Laura_Schedule(Clothes = 1, Location = 1, LocTemp = L_Loc):
        ...
        if (Current_Time == "Morning" and Clothes and Round >= 90) or Clothes == 2:
                ...
                if L_Schedule[Weekday] == 1:
                        ...
                        $ L_OutfitDay = "custom3"
                elif L_Schedule[Weekday] == 10 and L_Custom4[0]:
                        $ L_OutfitDay = "custom4"
                elif L_Schedule[Weekday] == 11 and L_Custom5[0]:
                        $ L_OutfitDay = "custom5"
                elif L_Schedule[Weekday] == 12 and L_Custom6[0]:
                        $ L_OutfitDay = "custom6"
                elif L_Schedule[Weekday] == 13 and L_Custom7[0]:
                        $ L_OutfitDay = "custom7"
                else: # random
                        $ Options = ["mission"]
